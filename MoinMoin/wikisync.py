...
class SyncPage(object):
    ...
    def merge(cls, local_list, remote_list):
        ...
        d = dict(list(zip(local_list, local_list)))
...
class MoinRemoteWiki(RemoteWiki):
    ...
    def createConnection(self):
        return xmlrpc.client.ServerProxy(self.xmlrpc_url, allow_none=True, verbose=self.verbose)
    ...
    def get_diff_post(self, value):
        ...
        if isinstance(value, xmlrpc.client.Fault):
    ...
    def merge_diff_pre(self, pagename, diff, local_rev, delta_remote_rev, last_remote_rev, interwiki_name, n_name):
        ...
        return "mergeDiff", (pagename, xmlrpc.client.Binary(diff), local_rev, delta_remote_rev, last_remote_rev, interwiki_name, n_name)
    ...
    def create_multicall_object(self):
        ...
        return xmlrpc.client.MultiCall(self.connection)
    ...
    def get_pages(self, **kwargs):
        options = {"include_revno": True,
                   ...
                   "mark_deleted": True}
        if self.token:
            m = xmlrpc.client.MultiCall(self.connection)
